...
public final class Constants {
  ...
  public static final class CanConstants {
    ...
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 43;
    public static final int FRONT_LEFT_MODULE_STEER_CANCODER = 7;
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = 187;

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 6;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 17;
    public static final int FRONT_RIGHT_MODULE_STEER_CANCODER = 5;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 303.5;

    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 18;
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 52;
    public static final int BACK_LEFT_MODULE_STEER_CANCODER = 8;
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = 308;
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 164;
