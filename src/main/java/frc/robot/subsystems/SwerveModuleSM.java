...
public class SwerveModuleSM extends SubsystemBase {
  ...
  public void periodic() {
    double angle = m_turnCANcoder.getAbsolutePosition();
    SmartDashboard.putNumber(m_locationIndex + "CanCoderPos",  angle);
    SmartDashboard.putNumber(m_locationIndex + "Turn Encoder", m_turnEncoder.getPosition());
  ...
  public void resetAngleToAbsolute() {
    double angle;
      ...
      SmartDashboard.putNumber(m_locationIndex + "SetEncoderPos",  angle);
